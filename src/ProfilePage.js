...
const ProfilePage = () => {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: '30px' }}>
      <div style={{ width: '90px', height: '90px', backgroundColor: '#c8102e', color: 'white', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '15px', boxShadow: '0 5px 15px rgba(200, 16, 46, 0.3)' }}>
      ...
      <h2 style={{ color: '#333', marginBottom: '5px' }}>Pandal Hopper</h2>
      <p style={{ color: '#777', fontSize: '14px', marginBottom: '30px' }}>hopper@manchitra.com</p>
      
      <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '15px' }}>
        <button className="navigate-btn" style={{ borderColor: '#ddd', color: '#333', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px' }}>
        ...
        <button className="navigate-btn" style={{ backgroundColor: '#fff', color: '#c8102e', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px' }}>
